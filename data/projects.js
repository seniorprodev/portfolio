const projects = [
  {
    name: "Anniecloth",
    description:
      "Anniecloth.com is a online shopping site for customers and VIPs to buy fashion clothes. This site was built by using Next.js",
    pic: "/7.jpg",
    tech: ["React", "Next.js", "Node.js", "Lodash"],
    links: [
      {
        label: "Github",
        icon: "github",
        url: "https://anniecloth.com/",
      },
    ],
  },
  {
    name: " Temasekshophouse",
    description:
    ...
    pic: "/5.jpg",
    tech: ["Laravel", "jQuery UI", "Bootstrap"],
    links: [
      {
        label: "Website",
        icon: "link",
        url: "https://www.temasekshophouse.org.sg/",
      },
    ],
  },
  {
    name: "Hometrust",
    description:
      "Hometrust is a platform to help customers to search interior designers, photos and projects. Using Vue and Laravel frameworks, this platfrom was built",
    pic: "/6.jpg",
    tech: ["Vue", "Laravel"],
    links: [
      {
  ...
  },
  {
    name: "Hotel",
    description:
      "Hotelscombined is a hotel booking platform. Using React library for front end and Node.js, MongoDB for backend, this platfrom was built",
    pic: "/8.jpg",
  ...
  },
  {
    name: "Beauty Studio",
    description:
      "This site was built using React library, Require.js and Lodash.",
    pic: "/4.jpg",
    tech: ["React", "Require.js", "Lodash"],
    links: [
      {
        label: "Website",
        icon: "link",
        url: "https://www.rrbeautystudio.com/",
      },
    ],
  },
];
